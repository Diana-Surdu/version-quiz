Semantic Version (or its short form - Semver) is a way of numbering a software release, and it uses a three numbersystem instead of a two number system of a release number of a software.
